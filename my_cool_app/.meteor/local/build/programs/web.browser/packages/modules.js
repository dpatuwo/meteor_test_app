...
install("ddp-rate-limiter");                                              // 62
install("localstorage");                                                  // 63
install("callback-hook");                                                 // 64
install("deps");                                                          // 65
install("htmljs");                                                        // 66
...
install("url");                                                           // 75
install("oauth");                                                         // 76
install("accounts-oauth");                                                // 77
install("npm-bcrypt");                                                    // 78
install("sha");                                                           // 79
install("srp");                                                           // 80
install("accounts-password");                                             // 81
install("less");                                                          // 82
install("accounts-ui-unstyled");                                          // 83
install("accounts-ui");                                                   // 84
install("oauth2");                                                        // 85
install("facebook");                                                      // 86
